...
import ProfileP from "../../img/pp.png";
  ...
  return (
    <div className="flex flex-col min-h-screen mx-auto">
      ...
      <div className="flex-1 flex flex-col items-center mx-auto">
        ...
        <div className="p-1 flex-auto flex ">
          <div className="w-full max-w-6xl mx-auto px-8">

            {/* Two Column Form */}
            <div className="grid grid-cols-2 gap-8 w-full max-w-8xl">
              {/* Left Column */}
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-96 p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#ff904f]"
                  />
                </div>
                <div>
              ...
              {/* Right Column */}
              <div className="space-y-4">
                <img src={ProfileP} alt="profile" className=""/>
              </div>
            </div>
        ...
        {/* Full-Width Footer */}
        <footer className="py-5 bg-neutral-50 shadow-md w-">
